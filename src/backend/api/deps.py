...
def init_tables(conn, db_type: str):
    ...
    if db_type == "postgres":
        ...
        cur.execute("ALTER TABLE drugs ADD COLUMN IF NOT EXISTS price NUMERIC(10,2) DEFAULT 0")
        cur.execute("ALTER TABLE drugs ADD COLUMN IF NOT EXISTS image_url TEXT")
        cur.execute("ALTER TABLE drugs ADD COLUMN IF NOT EXISTS manufacture_date DATE")
        cur.execute("ALTER TABLE drugs ADD COLUMN IF NOT EXISTS description TEXT")
        cur.execute("ALTER TABLE drugs ADD COLUMN IF NOT EXISTS manufacture_date DATE")
