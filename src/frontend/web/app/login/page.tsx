...
export default function CustomerLoginPage() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try { await customerLogin(email, password); window.location.href = "/shop"; }
        ...
        <div className="w-full max-w-[420px] relative z-10">
          ...
          <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-xl shadow-slate-200/50">
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              <button type="button" onClick={googleLogin} className="flex items-center justify-center gap-2 py-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-600 text-sm font-medium hover:bg-slate-100 hover:border-slate-300 transition-all">
              ...
              <button type="button" onClick={appleLogin} className="flex items-center justify-center gap-2 py-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-600 text-sm font-medium hover:bg-slate-100 hover:border-slate-300 transition-all">
